...
<!--
章节ID规范说明：
- 格式：{#arch-data-核心流程-[章节标识]}
- 必须标注ID的章节：核心类型定义、Schema、状态流转规则
- 示例：{#arch-data-核心流程-Phase类型} 表示核心流程模型数据模型的Phase类型定义
-->
...
### 2.1 Phase(阶段)相关类型 {#arch-data-核心流程-Phase类型}
...
## 三、state.json完整Schema {#arch-data-核心流程-Schema}
