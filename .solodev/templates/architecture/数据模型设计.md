...
<!--
章节ID规范说明：
- 格式：{#arch-data-[模块名]-[章节标识]}
- 必须标注ID的章节：Schema定义、字段说明、数据约束
- 示例：{#arch-data-state-schema} 表示state.json的完整Schema
- 示例：{#arch-data-state-字段说明} 表示state.json的字段说明
-->
...
#### 完整 Schema {#arch-data-[数据文件名]-schema}
