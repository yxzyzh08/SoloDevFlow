...
章节ID规范说明：
- 格式：{#arch-cmd-[章节标识]}
- 必须标注ID的章节：命令清单、每个命令的详细设计
- 示例：{#arch-cmd-命令清单} 表示命令设计文档的命令清单章节
- 示例：{#arch-cmd-init} 表示/init命令的详细设计
-->
...
### 2.2 /command1 - [命令名称] {#arch-cmd-[命令名]}
